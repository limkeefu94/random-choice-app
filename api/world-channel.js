...
function toWorldMessage(documentSnapshot, viewerAccountId = "") {
  ...
  return {
    ...
    avatarObjectName: data.avatarObjectName || "",
...
async function writeWorldMessage(request, response) {
  ...
  const message = {
    ...
    avatarObjectName: cleanText(account.avatarObjectName, 500),
    avatarFilePath: cleanText(account.avatarFilePath || account.avatarObjectName, 500),
    avatarPath: cleanText(account.avatarPath, 500),
    avatarStoragePath: cleanText(account.avatarStoragePath, 500),
    avatarPublicUrl: cleanText(account.avatarPublicUrl, 1200),
    text,
    attachment,
