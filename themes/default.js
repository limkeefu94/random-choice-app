(function () {
  ...
  const auroraLightTheme = {
    ...
    cssVars: {
      ...
      "--theme-background-overlay": "linear-gradient(135deg, rgba(244, 250, 255, 0.3), rgba(251, 245, 255, 0.2))",
      "--bg": "#eef5ff",
      "--bg-strong": "#e9e5ff",
      "--bg-middle": "#fbfdff",
      "--surface": "rgba(249, 252, 255, 0.82)",
      "--surface-solid": "#f9fcff",
      "--surface-raised": "rgba(255, 255, 255, 0.9)",
      "--surface-control": "rgba(237, 244, 255, 0.9)",
      "--input-bg": "#ffffff",
      "--glass": "rgba(252, 253, 255, 0.76)",
      "--ink": "#1f2944",
      "--muted": "#66728f",
      "--soft": "#dce5fb",
  ...
  const auroraDarkTheme = {
    ...
    cssVars: {
      ...
      "--theme-background-overlay": "linear-gradient(135deg, rgba(6, 12, 34, 0.34), rgba(10, 11, 42, 0.22))",
      "--bg": "#0b1029",
      "--bg-strong": "#101440",
      "--bg-middle": "#10183d",
      "--surface": "rgba(16, 26, 62, 0.84)",
      "--surface-solid": "#121b44",
      "--surface-raised": "rgba(20, 31, 70, 0.94)",
      "--surface-control": "rgba(33, 44, 89, 0.9)",
      "--input-bg": "#121c44",
      "--glass": "rgba(18, 28, 67, 0.8)",
      "--ink": "#f6f7ff",
      "--muted": "#bdc5e4",
      "--soft": "#293966",
