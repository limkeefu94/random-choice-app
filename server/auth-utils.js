...
function publicAccount(account) {
  ...
  return {
    ...
    avatarObjectName: cleanText(normalizedAccount.avatarObjectName, 500),
    avatarFilePath: cleanText(normalizedAccount.avatarFilePath, 500),
    avatarPath: cleanText(normalizedAccount.avatarPath, 500),
    avatarStoragePath: cleanText(normalizedAccount.avatarStoragePath, 500),
    avatarPublicUrl: cleanText(normalizedAccount.avatarPublicUrl, 1200),
